...
<section id="wsus__cart_view">
    <div class="container">
        <form class="wsus__checkout_form" method="post" action="{{ route('customer.checkout.form-submit') }}" id="form">
            @csrf
            <div class="row">
                <div class="col-xl-8 col-lg-7">
                    <div class="wsus__check_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-12 col-xl-6">
                                <div class="wsus__check_single_form">
                                    <input minlength="10" maxlength="10" id="sodienthoai" type="number"
            ...
            <div class="col-xl-4 col-lg-5" style="margin-top: 30px">
                <div class="wsus__order_details" id="sticky_sidebar">
                    ...
                    <div class="wsus__order_details_summery" id="total-box">
                        ...
                        {{-- <input hidden value={{$total}} name="total" type="text" readonly> --}}
                    </div>
...
var printResult = () => {
    ...
    // xử lý lại ajax để có thể gửi form
        ...
        $('#submitCheckoutForm').on('click', function(e){
            ...
            const total = {{ $total }}; // Lấy giá trị total từ Blade

            const inputElement = document.createElement('input');
            inputElement.setAttribute('type', 'text');
            inputElement.setAttribute('name', 'total');
            inputElement.setAttribute('value', total);
            inputElement.setAttribute('hidden', true);
            inputElement.setAttribute('readonly', true);

            document.getElementById('total-box').appendChild(inputElement);
